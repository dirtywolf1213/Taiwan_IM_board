...
TAXO = {
    ...
    '血液腫瘤': [
        ...
        ('Transfusion', ['transfusion', '輸血', 'blood product', 'trali', 'cryoprecipitate', 'packed red',
                         '血品']),
        ('Onc-Lung', ['lung cancer', '肺癌', 'non-small cell', 'nsclc', 'small cell lung', 'sclc', '肺腺癌',
                      'pancoast', 'superior sulcus', 'bronchogenic']),
        ('Onc-Breast', ['breast cancer', '乳癌', '乳房腫塊', 'her2', 'mastectomy', 'lumpectomy',
                        'estrogen receptor', 'ductal carcinoma', '乳房']),
        ('Onc-CRC', ['colon cancer', '結腸癌', '大腸癌', 'colorectal', 'sigmoid colon', '乙狀結腸',
                     'rectal cancer', 'colonic adenocarcinoma']),
        ('Onc-GU', ['prostate', '攝護腺', '前列腺', 'renal cell carcinoma', '腎細胞癌', 'bladder cancer',
                    '膀胱', 'urothelial', 'gross hematuria', '巨觀血尿', '無痛性血尿', 'testicular', '睪丸',
                    'prostate-specific antigen']),
        ('Onc-NET', ['neuroendocrine tumor', '神經內分泌瘤', 'carcinoid', '類癌', 'glucagonoma', 'gastrinoma',
                     'insulinoma', 'vipoma']),
        ('Onc-GI', ['pancreatic cancer', '胰臟癌', 'pancreatic ductal', 'pdac', 'painless jaundice',
                    '無痛性黃疸', 'gastric adenocarcinoma', '胃腺癌', '胃癌', 'hepatocellular', '肝細胞癌', 'hcc',
                    'esophageal cancer', 'cholangiocarcinoma', 'head of pancreas', '胰臟頭']),
        ('Onc-Melanoma', ['melanoma', '黑色素', 'braf v600']),
        ('Onc-GYN', ['cervical cancer', '子宮頸', 'ovarian cancer', '卵巢癌', 'endometrial', '子宮內膜']),
        ('Onc-Sarcoma', ['sarcoma', '肉瘤', 'osteosarcoma', '骨肉瘤', 'moth-eaten', 'ewing']),
        ('Onc-CUP', ['unknown primary', '原發部位不明', 'carcinoma of unknown']),
        ('Onc-Principles', ['immune checkpoint', '免疫節制點', 'targeted therap', '標靶', 'molecular targeted',
                            'tumor marker', '腫瘤標記', 'tumor lysis', '腫瘤溶解', 'paraneoplastic',
                            '腫瘤關聯症候群', 'immune evasion', '免疫逃脫']),
    ],
    '神經': [
