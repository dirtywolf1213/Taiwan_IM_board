...
def build_109():
    ...
    block(m, 67, 88, '腎臟')
    block(m, 101, 119, '感染')
    block(m, 120, 139, '新陳代謝與內分泌')
    block(m, 140, 159, '風濕免疫及過敏')
    block(m, 160, 179, '血液腫瘤')
    block(m, 180, 185, '神經')
    block(m, 187, 193, '精神')
    block(m, 194, 200, '皮膚')
    over = {
        72: '風濕免疫及過敏',   # 痛風
        # 第一堂整合題 89-100(各屬不同科)
        89: '消化', 90: '胸腔', 91: '腎臟', 92: '心臟血管',
        93: '新陳代謝與內分泌', 94: '新陳代謝與內分泌',
        95: '風濕免疫及過敏', 96: '風濕免疫及過敏', 97: '感染',
        98: '血液腫瘤', 99: '消化', 100: '神經',
        # 風濕免疫段中的跨科題
        142: '感染', 143: '感染', 145: '血液腫瘤',
        186: '心臟血管',   # 心房顫動處置
    }
    m.update(over)
    return m
...
MAPS = {
    ...
    111: build_111(), 110: build_110(), 109: build_109(),
}
